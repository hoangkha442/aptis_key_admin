...
export default function AddReadingPart2() {
  ...
  const onFinish = (values: any) => {
    setLoading(true);
    readingService
      .createReadingPart2(values)
      .then(() => {
        message.success("✅ Thêm câu hỏi Part 2 thành công!");
        form.resetFields();
      })
      .catch((err) => {
        console.error("❌ Error:", err);
        message.error("Thêm câu hỏi Part 2 thất bại!");
      })
      .finally(() => setLoading(false));
  };

  return (
    <Card title="Thêm câu hỏi Reading - Part 2" className="m-6 shadow-md">
      <Form
        form={form}
        layout="vertical"
        onFinish={onFinish}
      ...
      >
        <Row gutter={16}>
          ...
          <Col span={8}>
            ...
            >
              <Input placeholder="Buying a new house" />
            </Form.Item>
          </Col>
        </Row>
        ...
        >
          <Input.TextArea rows={2} placeholder="The first and most important thing is to choose the location" />
        </Form.Item>
